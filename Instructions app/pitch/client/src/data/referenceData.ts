...
export const countries: Country[] = [
  ...
  { id: 73, name: 'Micronesia, Federated States of', code: 'FM' },
  ...
  { id: 90, name: 'South Georgia and the South Sandwich Islands', code: 'GS' },
  ...
  { id: 96, name: 'Heard and McDonald Islands', code: 'HM' },
  ...
  { id: 126, name: 'Lao Peoples Democratic Republic', code: 'LA' },
  ...
  { id: 166, name: 'The Netherlands', code: 'NL' },
  ...
  { id: 180, name: 'St. Pierre and Miquelon', code: 'PM' },
  { id: 181, name: 'Pitcairn', code: 'PN' },
  { id: 182, name: 'Puerto Rico', code: 'PR' },
  { id: 183, name: 'Palestine, State of', code: 'PS' },
  ...
  { id: 201, name: 'Svalbard and Jan Mayen Islands', code: 'SJ' },
  ...
  { id: 211, name: 'Sint Maarten (Dutch part)', code: 'SX' },
  ...
  { id: 243, name: 'Wallis and Futuna Islands', code: 'WF' },
