...
export const mockNewEnquiries: NewEnquiry[] = [
  ...
  {
    id: 6,
    datetime: '2025-07-20T10:15:00',
    stage: 'enquiry',
    claim: '2025-07-20T10:15:00',
    poc: 'LZ',
    pitch: null,
    aow: 'misc/other',
    tow: 'General Legal Advice',
    moc: 'phone',
    rep: 'LZ',
    first: 'Michael',
    last: 'Other',
    email: 'michael.other@misc.co.uk',
    phone: '0606060606',
    value: '£1,200',
    notes: 'Phone inquiry about general legal advice that doesn\'t fit into standard practice areas.',
    rank: 'B',
    rating: 'Good',
    acid: 'ENQ-006-2025',
    card_id: null,
    source: 'referral',
    url: null,
    contact_referrer: 'Previous Client',
    company_referrer: 'ABC Corp',
    gclid: null,
  },
  {
    id: 7,
    datetime: '2025-07-25T15:45:00',
    stage: 'enquiry',
    claim: null,
    poc: 'team@helix-law.com',
    pitch: null,
    aow: 'misc/other',
    tow: 'Regulatory Compliance',
    moc: 'web_form',
    rep: 'LZ',
    first: 'Sarah',
    last: 'Compliance',
    email: 'sarah.compliance@regtech.com',
    phone: '0707070707',
    value: '£2,000',
    notes: 'Web form submission about regulatory compliance matters outside of standard practice areas.',
    rank: 'A',
    rating: 'Good',
    acid: 'ENQ-007-2025',
    card_id: null,
